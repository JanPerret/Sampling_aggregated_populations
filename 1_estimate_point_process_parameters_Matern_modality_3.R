...
# 
# 1_estimate_point_process_parameters_Matern_modality_3.R
# 
# jan.perret@gmail.com
#######################################################

###
### script objective : estimate the Matern process parameters to get the wanted levels of dispersion index - for modality 3 (intensity increased by increasing only mu)
###
...
# get the values of mu for each level of intensity given that the value of kappa is a constant = 0.01
kappa_vect = rep(0.01, times = 30)
mu_vect = wanted_intensities / kappa_vect
...
write.csv2(input_table, file = "./data/tidy/Matern_parameters_2021-06-24_mu.csv", row.names = FALSE)



### refine the estimates
# load the table
Matern_parameters_tab <- read.csv2("./data/tidy/Matern_parameters_2021-06-24_mu.csv")
...
# save results
write.csv2(parameter_tab, file = "./data/tidy/Matern_parameters_2021-06-24_mu_refined.csv", row.names = FALSE)
write.csv2(convergence_fails, file = "./data/tidy/Matern_parameters_2021-06-24_mu_convergence_fails.csv", row.names = FALSE)
...
# load the table
Matern_parameters_tab <- read.csv2("./data/tidy/Matern_parameters_2021-06-24_mu_refined.csv")
...
# save data
write.csv2(coef_tab_total, file = "./data/tidy/Matern_parameters_coef_tab_total_2021-06-24_mu.csv", row.names = FALSE)
...
#   ggtitle('Dispersion index as a function of the "scale" parameter of the Matern process (kappa fixed at 0.01)') +

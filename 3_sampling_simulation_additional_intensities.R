...
# 
# 3_sampling_simulation_additional_intensities.R
# 
# jan.perret@gmail.com
#######################################################

###
### script objective : simulate sampling surveys on previously generated patterns to estimate the true variance of various sampling designs - for modality 1 with intensities 5, 15, 25 and 30 individuals/cell
###
...
sample_size_vect = c(49, 100, 150, 196, 300, 400)
...
storage_folder <- "RUN_2022-06-08_simul_aggregation_intensity_results_additional_intensities"

# create a vector with the names of all files in the directory containing the previously generated count matrices
base_dir <- "./output/text/RUN_2022-06-08-simul_aggregation_intensity_patterns_additional_intensities/"

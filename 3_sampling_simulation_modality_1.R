...
# 
# 3_sampling_simulation_modality_1.R
# 
# jan.perret@gmail.com
#######################################################

###
### script objective : simulate sampling surveys on previously generated patterns to estimate the true variance of various sampling designs - for modality 1
###
...
storage_folder <- "RUN_2022-06-08_simul_aggregation_intensity_results_modality_1"

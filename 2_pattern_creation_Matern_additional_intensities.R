...
# 
# 2_pattern_creation_Matern_additional_intensities.R
# 
# jan.perret@gmail.com
#######################################################

###
### script objective : generate the Matern and Poisson patterns on which the sampling surveys will be simulated - for intensities c(5, 15, 25, 30)
###
...
storage_folder <- "RUN_2022-06-08-simul_aggregation_intensity_patterns_additional_intensities"
...
foreach (j = 1:nrow(coef_tab_total), .packages = "spatstat") %dopar% {
...
foreach (k = 1:length(intensity_vect), .packages = "spatstat") %dopar% {

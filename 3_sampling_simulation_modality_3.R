...
# 
# 3_sampling_simulation_modality_3.R
# 
# jan.perret@gmail.com
#######################################################

###
### script objective : simulate sampling surveys on previously generated patterns to estimate the true variance of various sampling designs - for modality 3
###
...
coef_tab_Matern <- read.csv2("./data/tidy/Matern_parameters_coef_tab_total_2021-06-24_mu.csv") # modality 3
...
storage_folder <- "RUN_2022-06-08_simul_aggregation_intensity_results_modality_3"

# create a vector with the names of all files in the directory containing the previously generated count matrices
base_dir <- "./output/text/RUN_2022-06-08-simul_aggregation_intensity_patterns_modality_3/"
